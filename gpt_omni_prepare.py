...
def prepare_gpt_omni(
    ...
    >>> prepare_gpt_omni(data_folder, save_folder, tr_splits, dev_splits, te_splits)
    """
    ...
    check_gpt_omni_folders(data_folder, splits)
...
def check_gpt_omni_folders(data_folder, splits):
    """
    Check if the data folder actually contains the gpt_omni dataset.
